...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> In dữ liệu</a>
                    </div>
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">3.520.000 VNĐ</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">400.333.333 VNĐ</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Lãi
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Bán hàng
                                        </span>
                                    </div>
                                </div>
                            </div>
...
<!-- Page level plugins -->
<script src="{{asset('adminclient/vendor/chart.js/Chart.min.js')}}"></script>

<!-- Page level custom scripts -->
<script src="{{asset('adminclient/js/demo/chart-area-demo.js')}}"></script>
<script src="{{asset('adminclient/js/demo/chart-pie-demo.js')}}"></script>
